use crate::network::raknet::packet::{
    read_packet_connection_open_request_1, read_packet_connection_open_request_2, read_packet_ping,
    write_packet_already_connected, write_packet_connection_open_reply_1,
    write_packet_connection_open_reply_2, write_packet_incompatible_protocol_version,
    write_packet_pong, AlreadyConnected, IncompatibleProtocolVersion, OpenConnectionReply1,
    OpenConnectionReply2, PacketID,
};
use crate::network::raknet::utils::{
    cur_timestamp_millis, RAKNET_CLIENT_MTU, RAKNET_PROTOCOL_VERSION, RAKNET_PROTOCOL_VERSION_LIST,
};
...
use super::error::{RaknetError, Result};
use super::socket::RaknetSocket;
            ...
            loop {
                ...
                match cur_status {
                    PacketID::UnconnectedPing1 => {
                        ...
                        let packet = crate::network::raknet::packet::PacketUnconnectedPong {
                            magic: true,
                            guid,
